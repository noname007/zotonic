...
// AC: 20150128: Removed unused class names. Changed messageClass to Bootstrap 3 conform "help-block". Replaced hardcoded "control-group" to fieldGroupClass, using Bootstrap 3 "form-group".
...
LiveValidation.prototype = {
        ...
        if(!this.validationFailed){
            if(this.displayMessageWhenEmpty || this.element.value !== ''){
                $('input[name="'+this.element.name+'"],select[name="'+this.element.name+'"],textarea[name="'+this.element.name+'"]')
                    .closest('.' + this.fieldGroupClass).addClass("success");
                switch (this.elementType) {
                case LiveValidation.RADIO:
                case LiveValidation.CHECKBOX:
            ...
            $('input[name="'+this.element.name+'"],select[name="'+this.element.name+'"],textarea[name="'+this.element.name+'"]')
                    .closest('.' + this.fieldGroupClass).removeClass("success").addClass(this.fieldGroupErrorClass);
    ...
    removeFieldClass: function(){
        $('input[name="'+this.element.name+'"],select[name="'+this.element.name+'"],textarea[name="'+this.element.name+'"]')
                .closest('.' + this.fieldGroupClass).removeClass("success").removeClass(this.fieldGroupErrorClass);
